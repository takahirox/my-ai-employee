...
from ai_employee.inspector import serve
...
class ServiceTests(unittest.TestCase):
    def test_inspector_uses_single_threaded_server_for_sqlite_connection(self) -> None:
        with (
            SQLiteStore(":memory:") as store,
            patch("ai_employee.inspector.HTTPServer") as server_type,
        ):
            serve(store, "127.0.0.1", 0)
