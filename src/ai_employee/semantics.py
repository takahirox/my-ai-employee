...
INPUT_PRESERVATION = (
    ...
    "descendants. preservation_mode='exact' (default) rejects additions, changes and deletions; "
    "preservation_mode='existing' protects every selected initial entry while allowing new "
    "entries. Select the mode according to the task requirements. Each selected path must "
    "exist in the Run's initial snapshot. Fleet compares content, executable flags, symlink "
    "targets and entry types against "
    ...
    "Keep the Goal's preserved_paths and preservation_mode on the Plan's result Task, "
    "including recovery. "
