        ...
        prompt = prompt_json(
            {
                ...
                "instruction": (
                    ...
                    "safety, compatibility, required error handling, or verification. The runtime "
                    "executes declared Harness commands against the composed candidate. Exact "
                    "verification_requirement_ids in a completion criterion already trace this "
                    "runtime verification; the node objective need not repeat an imperative to "
                    "run those commands. Do not request a verification-only node or a redundant "
                    "wording revision for an already bound check. Missing or incorrect "
                    "verification bindings and uncovered Goal requirements remain defects. Return "
